...
namespace NzbDrone.Core.MediaFiles
{
    ...
    public class TrackFileMovingService : IMoveTrackFiles
    {
        ...
        public TrackFile MoveTrackFile(TrackFile trackFile, Artist artist)
        {
            ...
            EnsureTrackFolder(trackFile, artist, filePath);
        ...
        {
            EnsureTrackFolder(trackFile, localTrack.Artist, filePath);
        }

        private void EnsureTrackFolder(TrackFile trackFile, Artist artist, string filePath)
        {
